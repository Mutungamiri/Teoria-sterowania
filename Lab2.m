function ster_3
 ...
 tx = 90;    % wartość z przedziału 1.0 - 179.0 min

T = 300;    % wartość z przedziału 298 - 398 K

S = 0.05;   % wartość z przedziału 0.0 - 0.1 m^3
...
legend('CA(t) - reaktor 1','CB(t) - reaktor 1','CC(t) - reaktor 1', ...

    'CA(t) - reaktor 2','CB(t) - reaktor 2','CC(t) - reaktor 2')
